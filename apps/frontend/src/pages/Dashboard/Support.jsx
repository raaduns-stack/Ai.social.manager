    ...
    async function loadFaqs() {
      try {
        ...
        if (data && data.length > 0) {
          ...
          setFaqs([
            { id: 'faq-1', category: 'General', question: 'How do I connect a new social media channel?', answer: 'Go to the Channels tab in your dashboard, click "Connect Channel", and follow the authorization steps for your selected platform.' },
            { id: 'faq-2', category: 'Billing', question: 'Where can I find my invoices?', answer: 'You can view and download all your past invoices from the Billing section in your account settings.' },
            { id: 'faq-3', category: 'General', question: 'What are AI Words?', answer: 'AI Words are credits used to generate post captions, hashtags, and strategy suggestions using our AI engine. Your quota refreshes every billing cycle.' },
            { id: 'faq-4', category: 'Team', question: 'How do I invite team members?', answer: 'On the Growth or Enterprise plan, you can invite team members by going to Settings > Team and clicking "Invite Member".' },
          ])
        }
      } catch (err) {
