...
import termsOfServiceMd from '../content/terms-of-service.md?raw';
...
function parseContent(text) {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (i === 0 || line === 'RaaSocial Terms of Use') {
      flushList(i);
      elements.push(
      ...
      // e.g. "1. The RaaSocial Service" or "10. Subscriptions and Billing"
      flushList(i);
      elements.push(
