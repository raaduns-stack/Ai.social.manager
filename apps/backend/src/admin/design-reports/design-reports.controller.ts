...
export class DesignReportsController {
  ...
  @RequirePermission('analytics', 'view')
  @ApiOperation({
    summary: 'Get staff performance on design tasks, reviews, approvals & revisions',
  })
  ...
  @RequirePermission('analytics', 'view')
  @ApiOperation({
    summary: 'Get designer payment & earnings financial breakdown and payout status distribution',
  })
  ...
  @RequirePermission('analytics', 'view')
  @ApiOperation({
    summary: 'Get overall design operational workflow stages and throughput metrics',
  })
