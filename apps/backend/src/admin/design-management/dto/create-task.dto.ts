...
export class CreateTaskDto {
  ...
  @ApiPropertyOptional({
    description: 'Brief or specifications',
    example: 'Design 3 variations in 1080x1080',
  })
  @IsString()
  @IsOptional()
  brief?: string;
  ...
  @ApiProperty({
    description: 'User ID of assigned graphic designer',
    example: 'd3b07384-d113-4676-96b6-96b6170d1000',
  })
  @IsUUID()
  @IsNotEmpty()
  assignedTo: string;
